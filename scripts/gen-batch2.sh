...
gen "service-intelligence" "Extreme close-up editorial documentary photograph: a person's hands typing on a dark laptop keyboard at night, fingers and keys lit entirely by the laptop screen's cool blue glow, nothing else in frame but hands, keyboard and soft bokeh reflections, very shallow depth of field, 35mm film grain, moody deep blue color grade, empty dark negative space in the upper third for overlay, no text, no logos, no readable screen content, no watermark"
